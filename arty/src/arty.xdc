...
create_clock -add -name eth_tx_clk -period 40.00 [get_ports { eth_tx_clk }];
create_clock -add -name eth_rx_clk -period 40.00 [get_ports { eth_rx_clk }];

#set_output_delay -clock eth_tx_clk -max 10  [get_ports eth_tx_en]
#set_output_delay -clock eth_tx_clk -min -10 [get_ports eth_tx_en]
#set_output_delay -clock eth_tx_clk -max 10  [get_ports eth_txd]
#set_output_delay -clock eth_tx_clk -min -10 [get_ports eth_txd]

#set_output_delay 10 -clock eth_tx_clk [get_ports eth_tx_en]
#set_output_delay 10 -clock eth_tx_clk [get_ports eth_txd]

#set_input_delay -clock eth_rx_clk -max 10 [get_ports eth_rx_dv]
#set_input_delay -clock eth_rx_clk -min 10 [get_ports eth_rx_dv]
#set_input_delay -clock eth_rx_clk -max 10 [get_ports eth_rxd]
#set_input_delay -clock eth_rx_clk -min 10 [get_ports eth_rxd]
